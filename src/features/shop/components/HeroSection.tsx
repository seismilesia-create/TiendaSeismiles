  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen overflow-hidden bg-[#FAFAF8]">
      ...
      >
        ...
        <div className="relative z-10 flex items-center min-h-[90vh] lg:min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
          <div className="max-w-3xl mx-auto text-center lg:text-left lg:mx-0">
            ...
            <h1 className="font-display text-[3.5rem] sm:text-[5rem] lg:text-[7rem] leading-[0.95] tracking-[0.04em] uppercase text-volcanic-900 mb-6">
              {hero.headline}
            </h1>
            <p className="text-body-lg lg:text-xl leading-relaxed text-volcanic-500 max-w-2xl mb-10">
              {hero.subheadline}
            </p>
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4">
              <MagneticButton>
                <Link
                  ...
                  className="group flex items-center gap-2 px-8 py-4 text-body-md font-semibold rounded-xl bg-volcanic-900 hover:bg-volcanic-800 text-white transition-all duration-300 hover:shadow-warm-lg"
                >
              ...
              <MagneticButton>
                <Link
                  ...
                  className="group flex items-center gap-2 px-8 py-4 text-body-md font-semibold rounded-xl bg-white/70 backdrop-blur-sm hover:bg-white text-volcanic-900 border border-volcanic-900/10 transition-all duration-300 hover:shadow-warm"
                >
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 h-[45vh] lg:inset-y-0 lg:left-0 lg:h-auto lg:w-1/2">
          <Image
          ...
          <div className="lg:hidden absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-volcanic-900 to-transparent" />
        </div>

        <div className="relative z-10 flex min-h-[90vh] lg:min-h-screen flex-col lg:flex-row">
          <div className="w-full lg:w-1/2 min-h-[45vh] lg:min-h-0" />
          <div className="flex items-center w-full lg:w-1/2 px-6 sm:px-10 lg:px-16 xl:px-20 py-12 lg:py-0">
            <div className="max-w-xl">
              ...
              <h1 className="font-display text-[2.75rem] sm:text-[3.5rem] lg:text-[4.5rem] xl:text-[5.5rem] leading-[0.95] tracking-[0.04em] uppercase text-white mb-6">
                {hero.headline}
              </h1>
              <p className="text-body-lg lg:text-xl leading-relaxed text-white/60 max-w-lg mb-10">
                {hero.subheadline}
              </p>
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <MagneticButton>
                  <Link
                    href={hero.ctaPrimary.href}
                    className="group flex items-center gap-2 px-8 py-4 text-body-md font-semibold rounded-xl bg-white hover:bg-sand-100 text-volcanic-900 transition-all duration-300 hover:shadow-warm-lg"
                  >
                    {hero.ctaPrimary.text}
                    <ArrowRightIcon className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
                  </Link>
                ...
                <MagneticButton>
                  <Link
                    href={hero.ctaSecondary.href}
                    className="group flex items-center gap-2 px-8 py-4 text-body-md font-semibold rounded-xl bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/15 transition-all duration-300"
                  >
                    {hero.ctaSecondary.text}
                    <ArrowRightIcon className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
                  </Link>
      ...
      >
        ...
        <div className="relative z-10 flex items-center min-h-[90vh] lg:min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-[3rem] sm:text-[4.5rem] lg:text-[6rem] leading-[0.95] tracking-[0.04em] uppercase text-white mb-6">
              Lo mejor para<br />esta temporada
            </h1>
            <p className="text-body-lg lg:text-xl leading-relaxed text-white/70 max-w-xl mb-10">
